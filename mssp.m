function [Sigma, Theta] = mssp(x, P, alpha, beta, kappa)
...
%   prior knowledge beta=2, secondary scaling kappa=0. 
%
...
%   ALPHA, prior knowledge beta=2, secondary scaling kappa=0.
%
%   [SIGMA, THETA] = MSSP(X,P,ALPHA,BETA) returns the Van der Merwe scaled 
%   sigma points SIGMA and weights THETA for mean X, covariance P, spread
%   ALPHA, prior knowledge BETA, secondary scaling kappa=0.
%
...
%   spread ALPHA, prior knowledge BETA, secondary scaling KAPPA.
%
